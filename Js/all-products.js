...
applyBtn.addEventListener("click", () => {
    ...
    showAllProducts(allProducts, filteredProducts)
})
...
resetBtn.addEventListener("click", () => {
    ...
    showAllProducts(allProducts, products)
})


function showAllProducts(content, data) {
    content.innerHTML = "";
    data.map((el) => {
        content.innerHTML += `
                         <div
                            class="hover:shadow-xl cursor-pointer  bg-[white] max-w-[350px] w-full border-[1px] rounded-[6px] overflow-hidden p-[7px] sm:p-[12px]  border-[#E3E3E8]">
