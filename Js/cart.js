...
//                                 <img src="../assets/cart/image 18 (3).png" alt="img" />
//                                 <div class='flex flex-col gap-[5px]'>
//                                     <p>Genesis</p>
//                                     <p class='w-full line-clamp-2 xl:line-clamp-0'>Масло Genesis SUPER 3000 X1
//                                         5W-40, 1 л. </p>
//                                     <p class='text-[#55556D] whitespace-nowrap'>Артикул: 0092S40240</p>
//                                 </div>
//                             </div>
...
//                                         </button>
//                                     </div>
//                                     <p class='text-[#7A7680] text-[12px]'>1 шт = 2 060 ₽ </p>
//                                 </div>
//                                 <p class='font-bold text-[18px] md:text-[18px] whitespace-nowrap'>2 060 ₽</p>
...
//     })
// }
// showCart(cartProducts, products)